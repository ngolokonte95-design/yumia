...
export const SHOP_CATEGORIES: ShopCategorySeed[] = [
  ...
  },
  {
    ...
    keywords: ['ecouteur', 'casque', 'enceinte', 'videoprojecteur', 'projecteur', 'montre', 'bracelet', 'lunette', 'appareil photo', 'manette', 'gaming', 'tapis', 'microphone', 'micro', 'led', 'ambiance', 'drone', 'platine', 'vinyle', 'liseuse', 'webcam', 'camera', 'station', 'recharge', 'batterie', 'chargeur', 'hub', 'usb', 'torche', 'traceur', 'gps', 'bluetooth', 'ampoule', 'connectee', 'connecte', 'prise', 'ruban', 'detecteur', 'mouvement', 'sonnette', 'serrure', 'empreinte', 'thermostat', 'capteur', 'reveil', 'projection', 'radio', 'voiture', 'transmetteur', 'aspirateur', 'recul', 'powerbank', 'solaire', 'multiprise', 'parasurtenseur', 'organiseur', 'cable', 'sacoche', 'adaptateur', 'jack', 'mp3', 'dab', 'tourne disque', 'valise', 'imprimante', 'scanner', 'stylo', 'traducteur', 'cadre', 'numerique', 'laser', 'wifi', 'rgb', 'rangement', 'support', 'telephone'],
  },
  {
    slug: 'plage-vacances',
    ...
    keywords: ['plage', 'mer', 'sable', 'balneaire', 'serviette', 'parasol', 'etanche', 'maillot', 'bouee', 'hamac', 'solaire', 'sandale', 'chapeau', 'tente', 'ballon', 'filet', 'brumisateur', 'ventilateur', 'lunette', 'paravent', 'coffre', 'poncho', 'jeu', 'tapis', 'glaciere', 'douche', 'matelas', 'pochette', 'support', 'transat', 'fauteuil', 'oreiller', 'voile d ombrage', 'brosse', 'maillot', 'etendoir', 'bodyboard', 'leash', 'wax', 'cerf volant', 'frisbee', 'palet', 'molkky', 'volley', 'telephone', 'etui', 'gourde', 'seau', 'pelle', 'rateau', 'moule', 'gilet', 'anti uv', 'bob', 'coffre fort', 'enfant', 'planche', 'surf', 'palme', 'sable'],
  },
  {
    slug: 'randonnee',
    ...
    keywords: ['randonnee', 'trekking', 'montagne', 'sac a dos', 'baton', 'gourde', 'frontale', 'boussole', 'survie', 'poncho', 'chaussette', 'couteau', 'secours', 'hydratation', 'sifflet', 'feu', 'filtre', 'pochette', 'genouillere', 'bache', 'corde', 'paracorde', 'trepied', 'couchage', 'matelas', 'housse', 'crampon', 'sac', 'jumelles', 'batterie', 'panneau solaire', 'montre', 'altimetre', 'porte carte', 'buff', 'casquette', 'manchette', 'semelle', 'ampoule', 'moustiquaire', 'bracelet', 'reflechissant', 'compression', 'organiseur', 'kit', 'reparation', 'ruban', 'embout', 'rondelle', 'tapis', 'rechaud', 'popote', 'gobelet', 'serviette', 'lacet', 'chaufferette', 'miroir', 'enfant', 'titane', 'microfibre'],
  },
  {
    slug: 'camping',
    ...
    keywords: ['camping', 'tente', 'bivouac', 'couchage', 'rechaud', 'lanterne', 'matelas', 'hamac', 'popote', 'glaciere', 'tarp', 'chaise', 'table', 'douche', 'toilette', 'guirlande', 'panneau solaire', 'ventilateur', 'sardine', 'tapis', 'four', 'cafetiere', 'rangement', 'couverture', 'feu', 'bache', 'marteau', 'lit', 'oreiller', 'drap', 'auvent', 'moustiquaire', 'kit', 'reparation', 'tempete', 'projecteur', 'station', 'rallonge', 'bidon', 'jerrican', 'vaisselle', 'egouttoir', 'bassine', 'caisse', 'cabine', 'brasero', 'grille', 'pince', 'filtre', 'voiture', 'tendeur', 'sac', 'enfant', 'jeu', 'douchette', 'barbecue', 'fenetre', 'elastique'],
  },
  {
    slug: 'pique-nique',
    nameFr: 'Pique-nique',
    ...
    keywords: ['pique-nique', 'pique nique', 'picnic', 'panier', 'glaciere', 'isotherme', 'nappe', 'plaid', 'couvert', 'gourde', 'apero', 'planche', 'boite repas', 'lunch', 'thermos', 'moulin', 'verre', 'tire bouchon', 'pack froid', 'distributeur', 'table', 'coussin', 'sac', 'boite', 'serviette', 'parasol', 'osier', 'couteau', 'chariot', 'cloche', 'bougie', 'citronnelle', 'bee wrap', 'emballage', 'hermetique', 'saladier', 'plateau', 'carafe', 'seau', 'paille', 'bambou', 'assiette', 'gobelet', 'porte bouteille', 'rafraichisseur', 'ouvre boite', 'planche', 'sac a pain', 'oeuf', 'chaise', 'lestee', 'pince', 'lanterne', 'solaire', 'gouter', 'enfant', 'lingette', 'range couverts', 'reutilisable'],
  },
  {
    ...
    keywords: ['piscine', 'natation', 'snorkeling', 'plongee', 'aquatique', 'bouee', 'palme', 'lunette', 'bonnet', 'maillot', 'peignoir', 'brassard', 'epuisette', 'matelas', 'fauteuil', 'robot', 'aspirateur', 'bache', 'echelle', 'pistolet', 'tapis', 'chausson', 'ceinture', 'pince', 'filet', 'jouet', 'planche', 'thermometre', 'sac', 'pull buoy', 'plaquette', 'tuba', 'elastique', 'haltere', 'frite', 'gant', 'flotteur', 'siege', 'testeur', 'bandelette', 'cartouche', 'skimmer', 'tuyau', 'pompe', 'filtration', 'solaire', 'hivernage', 'brosse', 'balai', 'panier', 'porte serviette', 'neoprene', 'douche', 'antiderapant', 'led', 'enfant', 'bebe', 'aquagym', 'serviette', 'lumiere'],
  },
  {
    slug: 'sport',
    ...
    keywords: ['haltere', 'banc', 'power tower', 'musculation', 'poids', 'rack', 'home gym', 'velo', 'appartement', 'rameur', 'tapis', 'course', 'barre', 'traction', 'pompe', 'abdominaux', 'kettlebell', 'elastique', 'sangle', 'corde', 'gant', 'ceinture', 'rouleau', 'massage', 'stepper', 'disque', 'shaker', 'montre', 'fitness', 'sport', 'entrainement', 'ballon', 'football', 'basket', 'volley', 'but', 'panier', 'plot', 'echelle', 'agilite', 'chronometre', 'sac', 'frappe', 'boxe', 'bande', 'protege dents', 'patte', 'puzzle', 'arts martiaux', 'sable', 'leste', 'gilet', 'chevillere', 'genouillere', 'manchon', 'compression', 'kinesiologie', 'poche', 'glace', 'gourde', 'hydratation', 'running', 'brassard', 'serviette', 'microfibre', 'grip', 'craie', 'magnesie', 'protection', 'roulement', 'telephone', 'jardin', 'maintien'],
  },
  {
    slug: 'yoga-bien-etre',
    ...
    keywords: ['massage', 'massant', 'pistolet', 'appareil', 'machine', 'yoga', 'meditation', 'pilates', 'etirement', 'relaxation', 'tapis', 'brique', 'sangle', 'coussin', 'roue', 'hamac', 'diffuseur', 'humidificateur', 'lampe', 'luminotherapie', 'bandeau', 'bol', 'balle', 'banc', 'traction', 'acupression', 'electrostimulation', 'fauteuil', 'rouleau', 'ceinture', 'nuque', 'cervical', 'cercle', 'pilates', 'ballon', 'bande', 'elastique', 'barre', 'equilibre', 'planche', 'bloc', 'mousse', 'serviette', 'antiderapante', 'sac', 'chaussette', 'gant', 'voyage', 'bolster', 'couverture', 'coton', 'lavande', 'huile', 'essentielle', 'galet', 'ceramique', 'brumisateur', 'aromatherapie', 'bougie', 'cire', 'encens', 'coffret', 'carillon', 'chantant', 'maillet', 'sablier', 'fleur', 'jade', 'gua sha', 'pierre', 'roller', 'froid', 'chaise', 'mural', 'rangement', 'visage', 'pliable', 'transport', 'masque', 'yeux'],
  },
  {
    ...
    keywords: ['cheveux', 'coiffure', 'coiffant', 'styler', 'seche-cheveux', 'seche cheveux', 'lisseur', 'boucleur', 'fer', 'brosse', 'soufflante', 'epilateur', 'ipl', 'lumiere pulsee', 'led', 'visage', 'masque', 'coiffeuse', 'miroir', 'maquillage', 'ultrasonique', 'sonique', 'radiofrequence', 'microcourant', 'lifting', 'tondeuse', 'peigne', 'pinceau', 'bigoudi', 'ciseaux', 'cape', 'appareil', 'nettoyeur', 'soin', 'bonnet', 'satin', 'taie', 'pince', 'chouchou', 'elastique', 'perruque', 'extension', 'bol', 'coloration', 'applicateur', 'meches', 'diffuseur', 'rouleau', 'velcro', 'papillote', 'turban', 'serviette', 'dents larges', 'demelante', 'epilation', 'cire', 'bande', 'eponge', 'nettoyant', 'organiseur', 'trousse', 'palette', 'ceinture', 'vaporisateur', 'enfant', 'boucles', 'microfibre'],
  },
  {
    slug: 'barbier',
    ...
    keywords: ['barbe', 'rasage', 'rasoir', 'tondeuse', 'barbier', 'moustache', 'blaireau', 'peigne', 'huile', 'baume', 'ciseaux', 'miroir', 'serviette', 'pochette', 'tablier', 'pinceau', 'shampoing', 'brosse', 'affuteur', 'coffret', 'kit', 'tete', 'cire', 'pommade', 'gel', 'spray', 'poudre', 'sabot', 'guide', 'degrade', 'finition', 'lame', 'foil', 'pochoir', 'nuque', 'papier', 'cape', 'tabouret', 'steamer', 'apres rasage', 'gommage', 'creme', 'bol', 'support', 'moustache', 'effilage', 'sac', 'lubrifiante', 'lampe', 'tapis', 'porte tondeuse', 'homme', 'jetable', 'visage', 'coiffant'],
  },
  {
    slug: 'onglerie',
    nameFr: 'Onglerie',
    ...
    keywords: ['ongle', 'manucure', 'pedicure', 'vernis', 'nail', 'capsule', 'ponceuse', 'lampe', 'strass', 'coupe-ongles', 'cuticule', 'coat', 'sticker', 'gel', 'lime', 'poudre', 'acrylique', 'support', 'presentoir', 'rape', 'sechoir', 'pochoir', 'aspirateur', 'pinceau', 'repose main', 'kit', 'presse', 'colle', 'dissolvant', 'bol', 'huile', 'creme', 'gants', 'chaussons', 'bain de pieds', 'pierre ponce', 'separateur', 'orteil', 'paillette', 'feuille', 'ruban', 'stamping', 'tampon', 'brosse', 'polissoir', 'pince', 'ciseaux', 'table', 'coussin', 'tapis', 'rangement', 'boite', 'loupe', 'chrome'],
  },
  {
    slug: 'cils-sourcils',
    ...
    keywords: ['cil', 'cils', 'sourcil', 'sourcils', 'extension', 'rehaussement', 'mascara', 'teinture', 'pince', 'pincette', 'pochoir', 'serum', 'hydrogel', 'lampe', 'loupe', 'recourbe', 'ventilateur', 'plateau', 'ruban', 'crayon', 'gel', 'magnetique', 'eyeliner', 'miroir', 'ciseaux', 'peigne', 'tapis', 'colle', 'brosse', 'patch', 'kit', 'primer', 'booster', 'dissolvant', 'nano mister', 'palette', 'goupillon', 'jetable', 'bandeau', 'oreiller', 'repose tete', 'tabouret', 'couverture', 'henne', 'cire', 'fil', 'epiler', 'epilation', 'regle', 'compas', 'savon', 'masque', 'anneau lumineux', 'boite', 'organiseur', 'tete', 'chariot', 'institut', 'coloration', 'maquillage', 'soin'],
  },
  {
    ...
    keywords: ['tatouage', 'tattoo', 'piercing', 'bijou', 'temporaire', 'septum', 'nombril', 'barbell', 'langue', 'boucle', 'creole', 'ecarteur', 'creme', 'baume', 'film', 'pansement', 'pochoir', 'crayon', 'nitrile', 'lampe', 'loupe', 'repose', 'housse', 'nettoyant', 'pince', 'coffret', 'presentoir', 'anneau', 'gant', 'arcade', 'helix', 'tragus', 'labret', 'nez', 'industriel', 'opale', 'zircon', 'plug', 'tunnel', 'chaine', 'henne', 'jagua', 'ephemere', 'savon', 'cicatrisant', 'ecran solaire', 'boite', 'organiseur', 'tabouret', 'bras', 'papier', 'regle', 'miroir', 'kit', 'enfant', 'fleur'],
  },
  {
    slug: 'fleuriste',
    ...
    keywords: ['fleur', 'plante', 'vase', 'bouquet', 'jardinage', 'pot', 'floral', 'secateur', 'arrosoir', 'mousse', 'ruban', 'kraft', 'brumisateur', 'guirlande', 'ciseaux', 'support', 'cache pot', 'serre', 'graine', 'semis', 'bulbe', 'potager', 'aromatique', 'jardiniere', 'kit', 'etiquette', 'tapis', 'germination', 'culture', 'decoration', 'engrais', 'orchidee', 'terreau', 'bille', 'argile', 'drainage', 'perle', 'arrosage', 'goutte a goutte', 'globe', 'minuteur', 'tuyau', 'extensible', 'pulverisateur', 'gant', 'transplantoir', 'griffe', 'rempotage', 'terre cuite', 'soucoupe', 'tuteur', 'lien', 'attache', 'treillis', 'grimpante', 'suspension', 'macrame', 'etagere', 'lampe', 'horticole', 'humidimetre', 'thermometre', 'couronne', 'sechees', 'fil de fer', 'pique', 'cellophane', 'boite', 'eucalyptus', 'jardin', 'verre', 'bambou'],
  },
  {
    slug: 'animalerie',
    nameFr: 'Animalerie',
    ...
    keywords: ['chien', 'chat', 'animal', 'animaux', 'harnais', 'laisse', 'gamelle', 'niche', 'griffoir', 'litiere', 'croquette', 'collier', 'panier', 'fontaine', 'arbre a chat', 'jouet', 'brosse', 'gant', 'coupe griffe', 'tondeuse', 'sac', 'caisse', 'coussin', 'tapis', 'barriere', 'friandise', 'aquarium', 'cage', 'rongeur', 'distributeur', 'pelle', 'anti glouton', 'set', 'gourde', 'boite', 'doseur', 'hermetique', 'clicker', 'dressage', 'sifflet', 'longe', 'anti traction', 'fouille', 'balle', 'lanceur', 'peluche', 'tunnel', 'herbe a chat', 'filtrant', 'biodegradable', 'desodorisant', 'lingette', 'shampooing', 'demeloir', 'ciseaux', 'baume', 'patte', 'manteau', 'couverture', 'grille', 'coffre', 'voiture', 'housse', 'siege', 'mangeoire', 'oiseau', 'perchoir', 'toilettage', 'promenade', 'jeu', 'nettoyante', 'voyage'],
  },
  {
    slug: 'cuisine',
  ...
  },
  {
    ...
    keywords: ['outil', 'bricolage', 'tournevis', 'perceuse', 'visseuse', 'cle', 'atelier', 'scie', 'niveau', 'laser', 'etabli', 'pince', 'marteau', 'vis', 'colle', 'detecteur', 'protection', 'servante', 'etau', 'visserie', 'cheville', 'lunette', 'casque', 'multimetre', 'fer a souder', 'ponceuse', 'meuleuse', 'lampe', 'rangement', 'metre', 'set', 'boite', 'pistolet', 'bulle', 'equerre', 'menuisier', 'cordeau', 'traceur', 'crayon', 'peinture', 'rouleau', 'bac', 'pinceau', 'bache', 'masquage', 'enduit', 'rebouchage', 'spatule', 'molette', 'tube', 'plomberie', 'joint', 'teflon', 'furet', 'deboucheur', 'canalisation', 'ventouse', 'denuder', 'testeur', 'tension', 'domino', 'connecteur', 'gaine', 'thermoretractable', 'serre cable', 'mastic', 'silicone', 'adhesif', 'double face', 'agrafeuse', 'agrafe', 'clou', 'gant', 'masque', 'poussiere', 'genouillere', 'casier', 'sac', 'travail', 'murale', 'nylon', 'evier'],
  },
  {
    slug: 'photo-creation',
    ...
    keywords: ['photo', 'trepied', 'ring light', 'gimbal', 'stabilisateur', 'objectif', 'studio', 'eclairage', 'micro', 'softbox', 'parapluie', 'filtre', 'carte memoire', 'declencheur', 'teleprompteur', 'fond', 'support', 'boite', 'table', 'reflecteur', 'bras', 'chroma', 'presentoir', 'sac', 'panneau', 'camera', 'video', 'batterie', 'chargeur', 'adaptateur', 'rallonge', 'alimentation', 'rotule', 'plaque', 'rail', 'perche', 'cage', 'pince', 'ventouse', 'nettoyage', 'poire', 'soufflette', 'lingette', 'silice', 'humidite', 'valise', 'courroie', 'harnais', 'rouleau', 'plateau', 'acrylique', 'marbre', 'bonnette', 'casque', 'cable', 'xlr', 'interface', 'cle usb', 'disque dur', 'lecteur', 'monitoring', 'kit', 'usb'],
  },
  {
    slug: 'cafe-the',
    nameFr: 'Café & thé',
    ...
    keywords: ['cafe', 'the', 'barista', 'cafetiere', 'theiere', 'moulin', 'expresso', 'infuseur', 'mousseur', 'filtre', 'tasse', 'tamper', 'pichet', 'machine', 'distributeur', 'plateau', 'bouilloire', 'thermometre', 'tapis', 'set', 'capsule', 'mug', 'carafe', 'balance', 'boite', 'dripper', 'support', 'v60', 'chemex', 'cold brew', 'bouteille', 'permanent', 'cone', 'detartrant', 'pastille', 'nettoyage', 'brosse', 'pinceau', 'marc', 'repartiteur', 'wdt', 'niveleur', 'pochoir', 'latte', 'stylo', 'cappuccino', 'porcelaine', 'verre', 'double paroi', 'sous tasse', 'cuillere', 'compartiment', 'pince', 'sachet', 'boule', 'passoire', 'fonte', 'chauffe', 'bougie', 'matcha', 'bol', 'fouet', 'bambou', 'chasen', 'rangement', 'tiroir', 'papier'],
  },
  {
    slug: 'meuble-deco',
    nameFr: 'Meuble & déco',
    ...
    keywords: ['meuble', 'etagere', 'rangement', 'coussin', 'housse', 'tapis', 'luminaire', 'suspension', 'lampe', 'applique', 'miroir', 'cadre', 'photo', 'decoration', 'deco', 'decorative', 'rideau', 'voilage', 'table', 'guirlande', 'organiseur', 'boite', 'panier', 'plante', 'commode', 'tiroir', 'porte manteau', 'tete de lit', 'porte photo', 'horloge', 'patere', 'porte parapluie', 'banc', 'chaussure', 'pivotant', 'parure', 'lit', 'plaid', 'jete', 'tricot', 'bain', 'douche', 'tableau', 'affiche', 'papier peint', 'cache pot', 'macrame', 'vase', 'bougie', 'parfumee', 'parfum', 'diffuseur', 'batonnet', 'photophore', 'lanterne', 'plateau', 'corbeille', 'jute', 'paravent', 'pouf', 'coffre', 'tabouret', 'console', 'desserte', 'sol', 'thermique', 'isolant', 'entree', 'ceramique', 'adhesif', 'support', 'mural', 'toile', 'verre'],
  },
  {
    slug: 'auto-moto',
    nameFr: 'Auto & moto',
    ...
    keywords: ['voiture', 'auto', 'moto', 'vehicule', 'coffre', 'pneu', 'allume-cigare', 'allume cigare', 'tapis de sol', 'housse', 'camera de recul', 'dashcam', 'jante', 'pare-soleil', 'pare soleil', 'casque', 'gant', 'alarme', 'antivol', 'demarreur', 'manometre', 'sacoche', 'support', 'nettoyant', 'kit', 'compresseur', 'aspirateur', 'organisateur', 'protection', 'reservoir', 'siege', 'coussin', 'appui tete', 'accoudoir', 'tablette', 'desodorisant', 'purificateur', 'led', 'ampoule', 'lampe', 'bache', 'antigel', 'raclette', 'degivrage', 'testeur', 'multimetre', 'valise', 'renovateur', 'polish', 'brosse', 'chiffon', 'microfibre', 'filet', 'barre de toit', 'sangle', 'bequille', 'selle', 'disque', 'intercom', 'miroir', 'entonnoir', 'chargeur', 'phare'],
  },
  {
    slug: 'velo-mobilite',
    ...
    keywords: ['velo', 'vtt', 'bicyclette', 'cycliste', 'cyclisme', 'trottinette', 'gyroroue', 'hoverboard', 'skateboard', 'draisienne', 'tricycle', 'electrique', 'antivol', 'sacoche', 'casque', 'pompe', 'compteur', 'selle', 'crevaison', 'bidon', 'eclairage', 'support', 'porte bagage', 'roue', 'batterie', 'pliant', 'pliable', 'adulte', 'enfant', 'pouce', 'chambre a air', 'pneu', 'demonte pneu', 'multi outil', 'rayon', 'derive', 'chaine', 'lubrifiant', 'degraissant', 'brosse', 'transmission', 'patin', 'frein', 'plaquette', 'disque', 'cable', 'gaine', 'pedale', 'poignee', 'guidon', 'ruban', 'garde boue', 'bequille', 'panier', 'remorque', 'filet', 'sonnette', 'retroviseur', 'gilet', 'reflechissant', 'brassard', 'gant', 'couvre selle', 'housse', 'mural', 'pied d atelier', 'reparation', 'nettoyage', 'rangement'],
  },
  {
    ...
    keywords: ['sac', 'pochette', 'lunettes de soleil', 'ceinture', 'foulard', 'echarpe', 'bandana', 'chale', 'chapeau', 'casquette', 'bob', 'beret', 'bonnet', 'portefeuille', 'porte carte', 'porte monnaie', 'gants mode', 'collier', 'bracelet', 'boucle d oreille', 'epingle', 'barrette', 'headband', 'pince a cheveux', 'porte cles', 'bandeau', 'noeud papillon', 'cravate', 'bretelles', 'broche', 'chaussettes', 'gilet', 'kimono', 'housse de telephone', 'porte passeport', 'parapluie', 'mode', 'fantaisie', 'tendance', 'fashion', 'ordinateur', 'week end', 'filet', 'seau', 'transparent', 'chaine de sac', 'organiseur', 'cordon', 'etui', 'mitaine', 'cache cou', 'tour de cou', 'feutre', 'visiere', 'satin', 'chouchou', 'pince crabe', 'rfid', 'trousse', 'cintre', 'penderie', 'peluche', 'embauchoir', 'tactile', 'pliant', 'voyage', 'laine', 'perle', 'brosse', 'housse', 'vetement', 'chaussure', 'bijoux', 'polaire', 'tricot', 'hiver', 'cheveux'],
  },
  {
    slug: 'lecture',
    ...
    keywords: ['livre', 'lecture', 'liseuse', 'marque-page', 'marque page', 'lampe', 'carnet', 'stylo', 'plume', 'roller', 'encre', 'calligraphie', 'lettering', 'feutre', 'tampon', 'washi', 'loupe', 'plaid', 'casque', 'coffret', 'papeterie', 'boite', 'trousse', 'serre-livres', 'serre livres', 'etagere', 'support', 'coussin', 'kit', 'set', 'pupitre', 'porte livre', 'lunettes', 'housse', 'sac', 'agenda', 'semainier', 'planificateur', 'intercalaire', 'recharge', 'cartouche', 'convertisseur', 'porte plume', 'buvard', 'regle', 'gabarit', 'pochoir', 'aquarelle', 'aquarellable', 'crayon', 'gomme', 'taille crayon', 'sous main', 'repose poignet', 'presse papier', 'signet', 'couvre livre', 'malette', 'range', 'bloc', 'bureau', 'encreur'],
  },
  {
    slug: 'bijoux-montres',
    ...
    keywords: ['bijou', 'collier', 'bracelet', 'bague', 'montre', 'pendentif', 'chaine', 'boucle', 'argent', 'acier', 'perle', 'broche', 'cheville', 'coffret', 'boucle d oreille', 'creole', 'chevaliere', 'parure', 'pierre', 'remontoir', 'outil', 'presentoir', 'pochette', 'boite', 'jonc', 'bracelet montre', 'cuir', 'silicone', 'milanais', 'coussin', 'chiffon', 'polish', 'ultrasons', 'gourmette', 'clips', 'medaillon', 'medaille', 'croix', 'breloque', 'charm', 'amethyste', 'quartz', 'plaque or', 'dore', 'reglable', 'titane', 'enfant', 'valise', 'arbre', 'porte bagues', 'ecrin', 'velours', 'miroir', 'rallonge', 'fermoir', 'personnalise', 'support', 'homme', 'nettoyage'],
  },
  {
    slug: 'jouets-cadeaux',
  ...
  },
  {
    ...
    keywords: ['televiseur', 'tv', 'smart tv', 'console', 'manette', 'volant', 'pc', 'ordinateur', 'clavier', 'souris', 'ecran', 'moniteur', 'tablette', 'smartphone', 'telephone', 'coque', 'videoprojecteur', 'projection', 'projecteur', 'hifi', 'amplificateur', 'enceinte', 'casque', 'realite virtuelle', 'imprimante 3d', 'filament', 'piano', 'batterie', 'autoradio', 'camera', 'support', 'barre de son', 'gaming', 'audio', 'routeur', 'wifi', 'repeteur', 'switch', 'reseau', 'ethernet', 'disque dur', 'ssd', 'cle usb', 'hub', 'dock', 'webcam', 'micro', 'visio', 'lampe', 'barre', 'repose pieds', 'tapis', 'bras', 'chargeur', 'onduleur', 'parasurtenseur', 'multiprise', 'passe cable', 'organiseur', 'station', 'recharge', 'grip', 'housse', 'carte memoire', 'connectee', 'ampoule', 'prise', 'surveillance', 'extension', 'bureau', 'usb', 'cable'],
  },
  {
    ...
    keywords: ['toile', 'chassis', 'peinture', 'peindre', 'panneau', 'chevalet', 'carnet', 'sketchbook', 'dessin', 'croquis', 'bloc', 'aquarelle', 'papier', 'miroir', 'tote bag', 'pochoir', 'pinceau', 'marqueur', 'crayon', 'acrylique', 'numero', 'diamond', 'argile', 'modelage', 'crochet', 'tricot', 'perle', 'tampon', 'scrapbooking', 'creatif', 'kit', 'coffret', 'set', 'lot', 'machine', 'coudre', 'couture', 'fil', 'bobine', 'tissu', 'coupon', 'patchwork', 'ciseaux', 'cranteur', 'metre', 'ruban', 'epingle', 'laine', 'pelote', 'aiguille', 'tricoter', 'metier', 'macrame', 'corde', 'resine', 'epoxy', 'pigment', 'mica', 'moule', 'bougie', 'meche', 'cire', 'soja', 'pince', 'fermoir', 'nylon', 'plioir', 'origami', 'massicot', 'perforatrice', 'decoupe', 'regle', 'boite', 'compartiment', 'chariot', 'rangement', 'fait main', 'diy', 'bijoux', 'tapis', 'silicone', 'coton'],
  },
  {
    slug: 'spa-massage',
    nameFr: 'Spa & massage',
    ...
    keywords: ['massage', 'massant', 'appareil', 'machine', 'pistolet', 'coussin', 'fauteuil', 'matelas', 'rouleau', 'ceinture', 'sauna', 'hammam', 'vapeur', 'infrarouge', 'couverture', 'diffuseur', 'humidificateur', 'brumisateur', 'pierre', 'bougie', 'huile', 'table', 'ventouse', 'gua sha', 'peignoir', 'sel', 'bain', 'spa', 'relaxation', 'nuque', 'cervical', 'pied', 'baignoire', 'plateau', 'brosse', 'gant', 'kessa', 'loofah', 'bouillotte', 'noyaux', 'micro ondes', 'masque', 'sommeil', 'soie', 'lampe', 'coucher de soleil', 'bruit blanc', 'meche', 'galet', 'drap', 'serviette', 'bandeau', 'chausson', 'capuche', 'balle', 'picots', 'bande', 'elastique', 'epsom', 'essentielle', 'lavande', 'porte', 'fontaine', 'encens', 'antiderapant', 'eponge', 'jetable', 'mousse', 'recuperation'],
  },
  {
    slug: 'cinema-maison',
    ...
    keywords: ['projecteur', 'videoprojecteur', 'projection', 'ecran', 'popcorn', 'barbe a papa', 'son', 'enceinte', 'home cinema', 'support', 'tablette', 'lampe', 'bandeau', 'plaid', 'coussin', 'pouf', 'telecommande', 'boitier', 'lunette', 'casque', 'cinema', 'guirlande', 'etoile', 'galaxie', 'boite', 'plateau', 'canape', 'led', 'machine', 'tv', 'cable', 'hdmi', 'repartiteur', 'commutateur', 'plafond', 'trepied', 'passe cable', 'multiprise', 'parafoudre', 'transmetteur', 'recepteur', 'bluetooth', 'caisson', 'basse', 'hot dog', 'distributeur', 'fontaine', 'saladier', 'carton', 'table', 'appoint', 'porte gobelet', 'accoudoir', 'housse', 'extensible', 'lave', 'aurore', 'neon', 'panneau', 'hexagonal', 'rangement', 'dvd', 'blu ray', 'panier', '3d', 'valise', 'toile', 'jardin', 'amplificateur', 'sac', 'mural', 'portable', 'decoratif', 'lumiere', 'meuble', 'salon'],
  },
  {
    slug: 'cake-design',
    ...
    keywords: ['patisserie', 'gateau', 'moule', 'douille', 'poche', 'colorant', 'tapis', 'emporte', 'plateau', 'spatule', 'lisseur', 'thermometre', 'caissette', 'cupcake', 'decoration', 'pate a sucre', 'rouleau', 'boite', 'silicone', 'cuisson', 'presentoir', 'perle', 'carton', 'pistolet', 'modelage', 'dentelle', 'pochoir', 'support', 'set', 'cercle', 'cadre', 'grille', 'refroidissement', 'macaron', 'madeleine', 'tarte', 'cannele', 'chinois', 'tamis', 'farine', 'corne', 'maryse', 'fouet', 'batteur', 'oeuf', 'siphon', 'chantilly', 'jetable', 'chocolat', 'polycarbonate', 'bonbon', 'fourchette', 'trempage', 'feuille', 'transfert', 'bougie', 'anniversaire', 'topper', 'cloche', 'sachet', 'biscuit', 'pinceau', 'cake', 'papier', 'stylo', 'alimentaire', 'paillette', 'comestible'],
  },
  {
  ...
  },
  {
    ...
    keywords: ['ski', 'snowboard', 'neige', 'montagne', 'antibuee', 'photochromique', 'masque', 'gant', 'sous-gant', 'chaussette', 'cagoule', 'tour de cou', 'bonnet', 'thermique', 'polaire', 'chaufferette', 'chauffe-main', 'casque', 'dorsale', 'genouillere', 'housse', 'porte-ski', 'glacier', 'sous-vetement', 'crampon', 'guetre', 'raquette a neige', 'baton', 'sechoir', 'fart', 'hiver', 'impermeable', 'luge', 'bouee', 'pelle', 'balai', 'grattoir', 'chaine', 'semelle', 'plaid', 'bouillotte', 'thermos', 'gourde', 'etui', 'lingette', 'sangle', 'sac', 'patin', 'moufle', 'echarpe', 'bandeau', 'pantalon', 'brosse', 'support', 'peaux de phoque', 'enfant'],
  },
  {
    slug: 'peche',
    nameFr: 'Pêche',
  ...
  },
  {
    ...
    keywords: ['bavoir', 'langer', 'gigoteuse', 'veilleuse', 'baignoire', 'thermometre de bain', 'humidificateur', 'couche', 'allaitement', 'chanceliere', 'ombrelle', 'moustiquaire', 'cape de bain', 'sortie de bain', 'siege de bain', 'protege-carnet', 'panier', 'rangement', 'organisateur', 'chambre', 'berceuse', 'nurserie', 'puericulture', 'protege matelas', 'drap housse', 'coupe-ongles', 'peigne', 'trousse', 'maternite', 'cintre', 'marche pied', 'reducteur de toilette', 'tapis de bain', 'moufle', 'toise', 'sticker', 'guirlande', 'cadre', 'album', 'souvenir', 'linge', 'porte-manteau', 'separateur', 'bandeau', 'chausson', 'piscine', 'assiette', 'compartiment', 'couverts', 'gobelet', 'repas', 'serviette', 'isotherme', 'gant de toilette', 'peignoir', 'capuche', 'filet', 'pichet', 'rincage', 'visiere', 'brosse a dents', 'sablier', 'marchepied', 'body', 'pyjama', 'chaussette', 'bonnet', 'legging', 'couverture', 'lange', 'dents de lait', 'carnet', 'projecteur', 'musical', 'bruit blanc', 'sommeil', 'pochette', 'coffre', 'jouets', 'silicone', 'elastique', 'souple', 'brodee', 'coton', 'sol', 'peinture'],
  },
];
