...
export const SHOP_CATEGORIES: ShopCategorySeed[] = [
  ...
  },
  {
    ...
    keywords: ['barbe', 'rasage', 'rasoir', 'tondeuse', 'barbier', 'moustache', 'blaireau', 'peigne', 'huile', 'baume', 'ciseaux', 'miroir', 'serviette', 'pochette', 'tablier', 'pinceau', 'shampoing', 'brosse', 'affuteur', 'coffret', 'kit', 'tete', 'pommade', 'spray', 'poudre', 'sabot', 'guide', 'degrade', 'finition', 'lame', 'foil', 'pochoir', 'nuque', 'cape', 'steamer', 'apres rasage', 'gommage', 'effilage', 'lubrifiante', 'porte tondeuse', 'coiffant', 'cire coiffante', 'creme a raser'],
  },
  {
    slug: 'onglerie',
    nameFr: 'Onglerie',
  ...
  },
  {
    ...
    keywords: ['massage', 'massant', 'appareil', 'machine', 'pistolet', 'coussin', 'fauteuil', 'matelas', 'rouleau', 'ceinture', 'sauna', 'hammam', 'vapeur', 'infrarouge', 'couverture', 'diffuseur', 'humidificateur', 'brumisateur', 'pierre', 'bougie', 'huile', 'table', 'ventouse', 'gua sha', 'peignoir', 'sel', 'bain', 'spa', 'relaxation', 'nuque', 'cervical', 'pied', 'baignoire', 'kessa', 'loofah', 'bouillotte', 'noyaux', 'micro ondes', 'soie', 'coucher de soleil', 'bruit blanc', 'meche', 'galet', 'drap', 'picots', 'epsom', 'essentielle', 'lavande', 'porte', 'encens', 'recuperation', 'brosse seche', 'masque yeux', 'bande elastique', 'fontaine zen'],
  },
  {
    slug: 'cinema-maison',
  ...
  },
  {
    ...
    keywords: ['patisserie', 'gateau', 'moule', 'douille', 'poche a douille', 'colorant', 'tapis', 'emporte', 'plateau', 'spatule', 'lisseur', 'thermometre', 'caissette', 'cupcake', 'decoration', 'pate a sucre', 'rouleau', 'boite', 'silicone', 'cuisson', 'presentoir', 'perle', 'carton', 'pistolet', 'modelage', 'dentelle', 'pochoir', 'support', 'set', 'cercle', 'refroidissement', 'macaron', 'madeleine', 'tarte', 'cannele', 'chinois', 'tamis', 'farine', 'corne', 'maryse', 'batteur', 'siphon', 'chantilly', 'chocolat', 'polycarbonate', 'bonbon', 'fourchette', 'trempage', 'feuille', 'transfert', 'anniversaire', 'topper', 'cloche', 'sachet', 'biscuit', 'cake', 'alimentaire', 'comestible'],
  },
  {
