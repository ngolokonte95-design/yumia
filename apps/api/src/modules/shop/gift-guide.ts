...
export const GIFT_OCCASIONS: readonly GiftOccasion[] = [
  {
    ...
    emoji: '🧓',
    categories: ['fleuriste', 'cafe-the', 'meuble-deco', 'spa-massage', 'cake-design', 'bricolage', 'coiffure-beaute'],
  ...
  },
  {
    ...
    label: 'Nouvel An',
    emoji: '🎆',
    categories: ['fete-decoration', 'cake-design', 'bijoux-montres', 'gadgets-tech', 'cinema-maison'],
...
export const GIFT_RECIPIENTS: readonly GiftRecipient[] = [
  ...
  { slug: 'ado', label: 'Un ado', emoji: '🎧', categories: ['gadgets-tech', 'bureau-teletravail', 'mode-accessoires', 'sport', 'photo-creation', 'velo-mobilite'] },
  { slug: 'couple', label: 'Un couple', emoji: '💑', categories: ['spa-massage', 'cinema-maison', 'cake-design', 'meuble-deco', 'pique-nique'] },
  { slug: 'ami', label: 'Un ami', emoji: '🤝', categories: ['cafe-the', 'bureau-teletravail', 'loisirs-creatifs', 'gadgets-tech', 'meuble-deco', 'mode-accessoires'] },
